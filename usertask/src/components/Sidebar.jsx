...
<div className='fixed top-[61px] bg-yellow-100/30  w-[300px] h-auto  p-2   min-h-[100vh] border-2 overflow-hidden'>
    ...
    <button><FaAngleDown className='w-6 h-6 ' /></button>  
      ...
      <div className='flex gap-3 border-2'>
        ...
        <div className='btnstyle flex gap-2 w-full text-start flex-col'>
        <button className='text-red-700'><FaCirclePlus className='w-5 h-5 text-red-700'/>Add task</button>
    <button onClick=''><FaSearch />Search</button>
    ...
    <button><TbFilterSearch />Filters&Labels</button>        
        ...
        <div className='btnstyle gap-2 mt-10 flex flex-col'>
            <p>My projects</p>
