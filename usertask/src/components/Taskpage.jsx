...
const Taskpage = () => {
  ...
  return (
   ...
   <div className=' relative  bg-zinc-600 w-full h-screen'>
    ...
    <div className='absolute p-5  top-[50%] z-[4] left-[50%] -translate-x-[50%] -translate-y-[50%] z-[9]  bg-sky-600 w-[500px] border-2 border-black h-[300px]'>
    
      <p className='text-center font-bold'>Add more task</p>
      <span>Enter task date:</span>
      <input className='my-2 mx-2' type="text" /><br/>
      <span>Enter task title:</span>
      <input type="text" className='my-2 mx-4' />
      <p>Enter task</p>
      <input type="text" className='border-2  w-full h-[100px] border-black'/>
    </div>
    </div>}
        <Foregound/>
